            ...
            configurations.all config@{
                dependencies.all {
                    ...
                    if (group == daggerGroupId && name == "dagger") {
                        dependencies {
                            add(this@config.name, "${extension.reflectDaggerGroupId}:dagger-reflect:${extension.daggerReflectVersion}")
                        }
                    }
                }
                resolutionStrategy {
                    ...
                    dependencySubstitution {
                        ...
                        substitute(
                            ...
                            with(module("${extension.reflectDaggerGroupId}:dagger-reflect-compiler:${extension.daggerReflectVersion}"))
